...
const STRINGS = {
  en: {
    ...
    log_source_motion_restored: "motion (restored)",
  ...
  sv: {
    ...
    log_source_motion_restored: "rörelse (återställd)",
...
class RoomFlowCard extends HTMLElement {
  ...
  _onChange(e) {
    ...
    const conditionAutoOff = e.target.closest("[data-condition-autooff]");
    if (conditionAutoOff) {
      const [roomId, conditionId] = conditionAutoOff.getAttribute("data-condition-autooff").split("|");
      this._updateCustomCondition(roomId, conditionId, "auto_off_time", conditionAutoOff.value || null);
      return;
    }
    ...
    const houseConditionAutoOff = e.target.closest("[data-house-condition-autooff]");
    if (houseConditionAutoOff) {
      this._updateHouseCondition(
        houseConditionAutoOff.getAttribute("data-house-condition-autooff"),
        "auto_off_time",
        houseConditionAutoOff.value || null
      );
      return;
    }
    ...
    const floorConditionAutoOff = e.target.closest("[data-floor-condition-autooff]");
    if (floorConditionAutoOff) {
      this._updateFloorCondition(
